...
export const NotificationToast: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-fade-in" dir="rtl">
      <div className="absolute inset-0 bg-black/10 z-40" onClick={() => dismissImportant(false)} />
      <div className="important-notification-toast bg-[var(--card-bg)] border border-[var(--border-color)] p-6 rounded-3xl max-w-md w-full shadow-[0_20px_50px_rgba(0,0,0,0.6)] text-right animate-scale-up space-y-4 z-50">

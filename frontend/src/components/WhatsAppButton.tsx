...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="max-w-0 overflow-hidden group-hover:max-w-xs group-hover:mr-2 transition-all duration-500 ease-out whitespace-nowrap text-xs font-bold tracking-wide select-none">

    ...
    <div className="bg-background text-foreground space-y-24 pb-20 overflow-x-hidden font-sans relative z-0 text-right" dir="rtl">
      ...
      <section className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden z-10">
        ...
        <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-slate-900/80 border border-slate-800 text-xs font-black shadow-lg backdrop-blur-md">
              <span className="flex h-2 w-2 relative">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-brand-primary opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-brand-primary"></span>
              </span>
              <span className="text-slate-300">منصة خطوتك 2.0 • منصة تعلّم شاملة في المناهج المدرسية، البرمجة، الأعمال والمهارات</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-right">
              ...
              >
                <h1 className="text-4xl sm:text-6xl xl:text-7xl font-black tracking-tight leading-[1.15] text-foreground">
                  استكشف شغفك، اكتسب مهاراتك، واصنع مستقبلك مع <span className="bg-gradient-to-r from-brand-primary via-indigo-400 to-brand-secondary bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(99,102,241,0.35)]">خطوتك</span>
                </h1>
                
                <p className="text-base sm:text-xl text-slate-300 font-medium leading-relaxed max-w-2xl opacity-95">
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {departments.filter(d => d.is_active).map((cat) => (
                  <button
                    ...
                    className="px-3.5 py-1.5 rounded-full bg-slate-900/80 hover:bg-brand-primary/20 border border-slate-800 hover:border-brand-primary/40 text-xs font-bold text-slate-300 transition-all cursor-pointer flex items-center gap-1.5"
                  >
                    <span>{cat.name}</span>
                  </button>
                ))}
              ...
              >
                ...
                <a 
                  ...
                  className="px-8 py-4 bg-slate-900/80 hover:bg-slate-800 border border-slate-800 rounded-2xl font-black text-sm text-foreground hover:border-brand-primary/40 active:scale-95 transition-all flex items-center gap-2.5 shadow-md"
                >
              ...
              <motion.div 
                ...
                className="pt-4 flex flex-wrap items-center gap-6 border-t border-slate-800/80 text-xs font-bold text-slate-400"
              >
            ...
            <div className="lg:col-span-5 relative">
              ...
              <motion.div
                ...
                className="relative bg-slate-950/80 border border-slate-800 rounded-[36px] p-6 sm:p-8 shadow-2xl space-y-6 overflow-hidden backdrop-blur-2xl"
              >
          ...
          {departments.filter(d => d.is_active).map((cat) => {
            ...
            return (
              <button
                ...
                className={`p-6 rounded-3xl border text-right transition-all duration-300 cursor-pointer flex flex-col justify-between space-y-4 group relative overflow-hidden ${
                  isActive
                    ? 'bg-brand-primary text-white border-brand-primary shadow-xl scale-[1.02]'
                    : 'bg-slate-950/80 hover:bg-slate-900 border-slate-800 hover:border-brand-primary/40'
                }`}
              >
                ...
                <div className="space-y-1.5">
                  <h3 className="font-black text-lg text-foreground group-hover:text-brand-primary transition-colors">{cat.name}</h3>
                  <p className={`text-xs font-medium leading-relaxed ${isActive ? 'text-white/90' : 'text-slate-400'}`}>
                    {cat.description}
                  </p>
                </div>

                <div className="pt-2 flex items-center gap-1.5 text-xs font-black text-brand-primary group-hover:translate-x-[-4px] transition-transform">
      ...
      <section id="advanced-filter" className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-24">
        ...
        <div className="bg-slate-950/90 border border-slate-800 rounded-[40px] p-6 sm:p-12 shadow-2xl relative overflow-hidden space-y-10">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 border-b border-slate-800/80 pb-6">
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-slate-400 font-medium">حدد المجال والتخصص لمشاهدة المدرسين الشارحين والدروس المتاحة للالتحاق بها</p>
            </div>
            ...
            {(selectedCategory !== 'all' || selectedGrade || selectedSubject || selectedTeacherId) && (
              <button 
                ...
                className="px-4 py-2 bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/20 text-rose-400 text-xs font-bold rounded-xl transition-all cursor-pointer shrink-0"
              >
                إعادة ضبط الفلاتر 🔄
              </button>
            )}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    {safeFilteredTeachers.map((t) => {
                      ...
                      return (
                        ...
                        >
                          <div className="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center font-black text-xs shrink-0 overflow-hidden">
                            {t.avatar ? (
          ...
          {filterLoading && (
            <div className="py-12 flex justify-center items-center gap-3">
              ...
              <span className="text-xs font-bold text-slate-400">جاري تجميع الكورسات والمحاضرات...</span>
            </div>
          )}
      ...
      <section className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-slate-950/80 border border-slate-800 p-6 rounded-3xl space-y-4 hover:border-brand-primary/40 transition-all group">
            ...
            <h3 className="font-black text-base text-foreground">محاضرات وحماية عالية</h3>
            <p className="text-xs text-slate-400 font-medium leading-relaxed">
              فيديوهات بدقة HD محمية بسيرفرات Bunny CDN السريعة مع حفظ موضع الوقوف التلقائي.
            </p>
          </div>

          <div className="bg-slate-950/80 border border-slate-800 p-6 rounded-3xl space-y-4 hover:border-brand-secondary/40 transition-all group">
            ...
            <h3 className="font-black text-base text-foreground">امتحانات وتصحيح فوري</h3>
            <p className="text-xs text-slate-400 font-medium leading-relaxed">
              اختبارات MCQ وتدريبات تفاعلية مع تصحيح تلقائي وعرض الدرجة والملاحظات مباشرة.
            </p>
          </div>

          <div className="bg-slate-950/80 border border-slate-800 p-6 rounded-3xl space-y-4 hover:border-emerald-500/40 transition-all group">
            <div className="w-12 h-12 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 font-black group-hover:bg-emerald-500 group-hover:text-white transition-all">
              <Wallet className="h-6 w-6" />
            </div>
            <h3 className="font-black text-base text-foreground">محفظة وشحن بالأكواد</h3>
            <p className="text-xs text-slate-400 font-medium leading-relaxed">
              نظام محفظة ذكي يتيح لك شحن رصيدك فوراً عبر أكواد الشحن المسبقة الدفع بسهولة.
            </p>
          </div>

          <div className="bg-slate-950/80 border border-slate-800 p-6 rounded-3xl space-y-4 hover:border-amber-500/40 transition-all group">
            <div className="w-12 h-12 rounded-2xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400 font-black group-hover:bg-amber-500 group-hover:text-white transition-all">
              <Award className="h-6 w-6" />
            </div>
            <h3 className="font-black text-base text-foreground">نخبة المعلمين والخبراء</h3>
            <p className="text-xs text-slate-400 font-medium leading-relaxed">
      ...
      <section className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10 border-b border-slate-800/80 pb-6">
          <div className="space-y-1">
            ...
            <p className="text-xs sm:text-sm text-slate-400 font-medium">اشترك الآن في أحدث الشروحات التعليمية وتابع مع معلمك فوراً</p>
          </div>
      ...
      <section className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-3 max-w-xl mx-auto mb-14">
          ...
          <p className="text-xs sm:text-sm text-slate-400 font-medium">معلمون وخبراء متميزون في مختلف التخصصات لمساعدتك في رحلة التعلم</p>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center space-y-3 mb-14">
          ...
          <p className="text-xs sm:text-sm text-slate-400 font-medium">إجابات توضيحية حول طريقة الشراء والشحن والدراسة بالمنصة</p>
        </div>
      ...
      <section className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-br from-brand-primary/20 via-slate-950 to-brand-secondary/20 border border-slate-800 rounded-[40px] p-8 sm:p-16 text-center space-y-6 relative overflow-hidden shadow-2xl">
          ...
          <p className="text-xs sm:text-base text-slate-300 font-medium max-w-lg mx-auto leading-relaxed">
      ...
      <AnimatePresence>
        {open && (
          <motion.div 
            ...
            className="overflow-hidden border-t border-slate-800/80 bg-slate-900/30"
          >
            <p className="p-5 text-xs sm:text-sm text-slate-300 font-medium leading-relaxed">
              {answer}
            </p>
          </motion.div>
        )}

  ...
  return (
    <div className="border border-[var(--border-color)] bg-brand-card/30 rounded-2xl overflow-hidden transition-all duration-300">
      <button
        ...
        className="w-full flex items-center justify-between p-6 text-right font-semibold text-sm sm:text-base cursor-pointer text-slate-900 dark:text-white hover:text-[var(--primary-color)] dark:hover:text-[var(--primary-color)] transition-colors"
      >
        <span>{question}</span>
      ...
      <div className={`transition-all duration-300 overflow-hidden ${open ? 'max-h-96 border-t border-[var(--border-color)] bg-brand-surface/10' : 'max-h-0'}`}>
        <p 
          className="pt-5 pb-7 px-6 text-xs sm:text-sm text-slate-700 dark:text-slate-300 font-normal"
